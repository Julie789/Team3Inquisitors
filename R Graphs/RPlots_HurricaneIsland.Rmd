...
ggplot(data = Net2VsCage6_long, mapping = aes(x= Date, y= value, color = variable))+ geom_smooth()+ ggtitle("Net(Surface) temperature vs Cage(Bottom) Temperature")
```

  * Create facet plot of data, store in global variable
```{r surfvsbottemp_facetplot}
ggplot(data = Net2VsCage6_long, mapping = aes(x= Date, y= value, color = variable))+ geom_point() + facet_wrap(~ variable, nrow=2)+ ggtitle("Net(Surface) temperature vs Cage(Bottom) Temperature")
```
